...
//                                         {&GSDataCenter::Thermistor_FillingStation_PlotData[0],
//                                         &GSDataCenter::Thermistor_FillingStation_PlotData[1],
//                                          &GSDataCenter::Thermistor_FillingStation_PlotData[2],
//                                          &GSDataCenter::Thermistor_FillingStation_PlotData[3],
//                                          &GSDataCenter::Thermistor_FillingStation_PlotData[4],
//                                          &GSDataCenter::Thermistor_FillingStation_PlotData[5],
//                                          &GSDataCenter::Thermistor_FillingStation_PlotData[6],
//                                          &GSDataCenter::Thermistor_FillingStation_PlotData[7]});
//
...
std::vector<HelloImGui::DockableWindow> PlotWindowCenter::createDockableWindows() {
    ...
    // PlotWindowCenter::thermistorMotorPlot.render(); }); HelloImGui::DockableWindow pressureSensorMotorPlotDockWin
    // (pressureSensorMotorPlot.getWindowId(),          ImGuiConfig::Dockspace::PLOT, []() { PlotWindowCenter::pressureSensorMotorPlot.render(); });
    ...
    // []() { PlotWindowCenter::thermistorFillingStationPlot.render(); }); HelloImGui::DockableWindow pressureSensorFillingStationPlotDockWin
    // (pressureSensorFillingStationPlot.getWindowId(), ImGuiConfig::Dockspace::PLOT, []() {
    // PlotWindowCenter::pressureSensorFillingStationPlot.render(); }); HelloImGui::DockableWindow loadCellFillingStationPlotDockWin
    // (loadCellFillingStationPlot.getWindowId(),       ImGuiConfig::Dockspace::PLOT, []() { PlotWindowCenter::loadCellFillingStationPlot.render();
    // });
    //// clang-format on
