...
// Deactivated windows (their .cpp are excluded from the build via premake removefiles):
...
std::vector<std::shared_ptr<UIWindow>> windows = {communicationWindow, loggingWindow};
} // namespace UIWindows
